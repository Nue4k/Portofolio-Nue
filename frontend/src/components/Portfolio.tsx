        ...
        <section id="portfolio" className="py-20 px-8 md:px-20 w-full bg-amber-50/50 dark:bg-slate-900">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mt-16 text-center">
                    <Link href="#" className="inline-flex items-center gap-2 text-amber-600 dark:text-emerald-500 font-medium hover:underline hover:underline-offset-4">
